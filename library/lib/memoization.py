...
# функції для роботи з кешом
    def __init__(self, func, max_size=10, ttl=None): # запис функції з параметрами, максимальний розмір кешу(кількість запитів), ttl параметр часу(за замовчеванням обмеження немає)
        self.func = func
    ...
    def __call__(self, *args):
        now = time.time() # зчитування поточного часу під час виклику функції
